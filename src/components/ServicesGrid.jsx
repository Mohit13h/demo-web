      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div>
            ...
            <h3 style={{ fontSize: '1.75rem', fontWeight: 800, color: '#ffffff', marginBottom: '0.75rem', lineHeight: 1.25 }}>
              Is Your Car Squeaking or Taking Longer to Stop?
            </h3>
            <p style={{ color: '#cbd5e1', fontSize: '0.975rem', lineHeight: 1.6, marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.5rem' }}>
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#e2e8f0', fontSize: '0.875rem' }}>
                <CheckCircle2 size={16} color="#10b981" /> Ceramic Low-Dust Pads
              </span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#e2e8f0', fontSize: '0.875rem' }}>
                <CheckCircle2 size={16} color="#10b981" /> Rotor Resurfacing & Replacement
              </span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#e2e8f0', fontSize: '0.875rem' }}>
                <CheckCircle2 size={16} color="#10b981" /> {businessInfo.warranty}
              </span>
            </div>
            <button
                ...
                <div>
                  ...
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.45rem', marginBottom: '1.5rem' }}>
                    {svc.features.map((feat, fIdx) => (
                      <li key={fIdx} style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', fontSize: '0.825rem', color: '#e2e8f0' }}>
